...
Look at `site/shots/desktop-50.png` and `site/shots/mobile-50.png` with your own eyes. Ask: does the headline fit in 2 lines. Is the poster visible before frames. Does the peak feel like the peak.
...
- [ ] Poster visible before frames load (shots/desktop-0.png)
